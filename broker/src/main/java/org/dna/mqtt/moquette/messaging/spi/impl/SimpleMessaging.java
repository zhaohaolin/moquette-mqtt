...
public class SimpleMessaging implements IMessaging, EventHandler<ValueEvent> {
	...
	public void onEvent(ValueEvent t, long l, boolean bln) throws Exception {
		...
		if (evt instanceof PublishEvent) {
			...
			String clientID = (String) disEvt.getSession().getAttribute(
			...
			if (message instanceof ConnectMessage) {
				...
				String clientID = (String) session
						.getAttribute(Constants.ATTR_CLIENTID);
				m_processor.processUnsubscribe(session, clientID,
						unsubMsg.topics(), unsubMsg.getMessageID());
				...
				m_processor.processSubscribe(session,
						(SubscribeMessage) message, clientID, cleanSession);
