...
public class Subscription implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if ((this.clientId == null) ? (other.clientId != null) : !this.clientId
				.equals(other.clientId)) {
			return false;
		}
		if ((this.topic == null) ? (other.topic != null) : !this.topic
				.equals(other.topic)) {
			return false;
		}
		return true;
	...
	public int hashCode() {
		...
		hash = 37
				* hash
				+ (this.requestedQos != null ? this.requestedQos.hashCode() : 0);
		hash = 37 * hash
				+ (this.clientId != null ? this.clientId.hashCode() : 0);
	...
	public String toString() {
		return String.format("[t:%s, cliID: %s, qos: %s]", this.topic,
				this.clientId, this.requestedQos);
	}
}
